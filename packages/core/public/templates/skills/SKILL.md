...
| 文档 | 职责 |
|---|---|
| [lattice-rules.md] | 起手/实施期/失忆恢复/归档硬约束/回答闭合自检 |
| [project-context.md] | 进入项目动作、搜索、嵌套继承 |
| [spec-workflows.md] | spec 读写、沉淀判定 |
| [task-workflows.md] | 任务全周期 |
| [subagent-delegation.md] | 委派判定、dispatch prompt 契约、返回格式 |

...
1. **PRD 永不落后于代码**：目标 / 边界 / 选型 / 取舍 / 文件清单 / 风险任何变化必须**先**改 prd.md 再改代码——"嘴上答应了、代码改了、PRD 没动" = 跨会话失忆最大来源
...
5. **过程中即沉淀 spec**：冒出长期可复用的内容时**立即询问用户是否沉淀**，不要拖到归档前
